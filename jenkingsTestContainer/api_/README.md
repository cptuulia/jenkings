...
```
mysql -h localhost -P 3306 --protocol=tcp -uroot -proot pdf_encrypt_db_name
```
This should also work woth mysql clients like Mysql Workbench and Sequel ACE (not Sequel pro)
